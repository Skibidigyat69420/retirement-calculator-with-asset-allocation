...
#define CONFIGURE_ARGS " '--prefix' '/opt/postgresql' '--enable-integer-datetimes' '--enable-option-checking=fatal' '--with-gssapi' '--without-icu' '--without-ldap' '--with-libxml' '--with-libxslt' '--with-lz4' '--with-openssl' '--with-pgport=5432' '--with-python' '--with-readline' '--with-system-tzdata=/usr/share/zoneinfo' '--with-uuid=ossp' '--with-zstd' 'LLVM_CONFIG=/usr/lib/llvm-16/bin/llvm-config' 'CLANG=clang-16'"
...
#define PACKAGE_STRING "PostgreSQL 17.11"
...
#define PG_VERSION "17.11"

/* PostgreSQL version as a number */
#define PG_VERSION_NUM 170011

/* A string containing the version number, platform, and C compiler */
#define PG_VERSION_STR "PostgreSQL 17.11 on x86_64-pc-linux-gnu, compiled by gcc (Debian 12.2.0-14+deb12u1) 12.2.0, 64-bit"

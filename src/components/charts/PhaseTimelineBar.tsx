  ...
  return (
    <div role="img" aria-label={ariaLabel ?? description}>
      ...
      <div className="w-full h-5 bg-sunken rounded-full overflow-hidden flex border border-border">
        ...
        >
          {accPct > 14 && (
            <span className="text-[10px] font-bold text-on-inkfill truncate px-2">Accumulation · {accYears}y</span>
          )}
        </div>
        <div
        ...
        >
          {fundedPct > 16 && (
            <span className="text-[10px] font-bold text-on-inkfill truncate px-2">Funded SWP · {fundedYears}y</span>
          )}
        </div>
        {gapPct > 0 && (
          <div
          ...
          >
            {gapPct > 12 && (
              <span className="text-[10px] font-bold text-on-inkfill truncate px-2">Gap · {gapYears}y</span>
            )}
          </div>
        )}
      </div>

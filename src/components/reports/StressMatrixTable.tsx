            ...
            return (
              <tr key={r.scenario.id}>
                <td className="p-3">
                  ...
                  <p className="text-[10px] text-muted">{r.scenario.historicalPeriod}</p>
                </td>
                ...
                <td className={cn('p-3 text-right font-mono font-semibold', r.corpusDelta < 0 ? 'text-negative' : 'text-positive')}>
                  {r.corpusDelta < 0 ? '−' : '+'}

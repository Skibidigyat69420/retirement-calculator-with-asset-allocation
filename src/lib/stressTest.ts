...
export const CRISIS_PRESETS: CrisisScenario[] = [
  {
    ...
    shortDescription: 'Global banking & credit collapse with severe equity & property drawdowns.',
    ...
    otherShock: -0.25,
    inflationDelta: -1.0,
    narrative: 'High-risk equities collapsed worldwide while sovereign debt and gold provided flight-to-safety buffering.',
  },
  {
    id: 'covid-2020',
    name: '2020 COVID Flash Crash',
    shortDescription: 'Sudden liquidity crunch followed by aggressive central bank stimulus.',
    ...
    otherShock: -0.15,
    inflationDelta: -0.5,
    narrative: 'Rapid market sell-off halted by unprecedented fiscal liquidity injections, sparking huge gold outperformance.',
  },
  {
    id: 'stagflation-1970s',
    name: '1970s Great Stagflation Shock',
    shortDescription: 'Sustained inflation surge with simultaneous equity and bond drawdowns.',
    ...
    otherShock: 0.05,
    inflationDelta: 4.0,
    narrative: 'Yields spiked, eroding bond portfolios while high inflation eroded real corporate earnings. Hard commodities surged.',
  },
  {
    id: 'dotcom-2000',
    name: '2000 Dot-Com Tech Bubble Bust',
    shortDescription: 'Severe valuation compression in growth equities with rotation to quality.',
    ...
    otherShock: -0.30,
    inflationDelta: -0.5,
    narrative: 'A multi-year grinding bear market in speculative equities with high grade bonds insulating capital.',
  },
];

      ...
      <div className="flex border-b border-slate-200 gap-6 overflow-x-auto whitespace-nowrap">
        <button
          ...
          className={`pb-3 text-sm font-semibold transition-all relative ${
            activeTab === 'connect' ? 'text-navy border-b-2 border-amber-500' : 'text-slate-600 hover:text-navy'
          }`}
        >
        ...
        <button
          ...
          className={`pb-3 text-sm font-semibold transition-all relative ${
            activeTab === 'guide' ? 'text-navy border-b-2 border-amber-500' : 'text-slate-600 hover:text-navy'
          }`}
        >
        ...
        <button
          ...
          className={`pb-3 text-sm font-semibold transition-all relative ${
            activeTab === 'holdings' ? 'text-navy border-b-2 border-amber-500' : 'text-slate-600 hover:text-navy'
          }`}
        >
        ...
        <button
          ...
          className={`pb-3 text-sm font-semibold transition-all relative ${
            activeTab === 'scripts' ? 'text-navy border-b-2 border-amber-500' : 'text-slate-600 hover:text-navy'
          }`}
        >
          ...
          <Card className="lg:col-span-2 space-y-6">
            <div className="flex items-center justify-between">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="text-xs text-navy flex items-center gap-1 hover:text-amber-500 underline"
              >
            ...
            <form onSubmit={handleConnect} className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    aria-label="API Key"
                    className="w-full px-3.5 py-2.5 bg-white border border-slate-200 rounded-xl text-sm font-mono focus:outline-none focus:border-navy"
                    required
                  />
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 bg-white border border-slate-200 rounded-xl text-sm focus:outline-none focus:border-navy"
                    required
                  />
                </div>
                ...
                <div>
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="text-[11px] text-navy hover:text-amber-500 underline flex items-center gap-1"
                    >
              ...
              {creds.totpSecret && (
                <div className="p-3 bg-slate-50 rounded-xl border border-slate-200 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-[11px] uppercase tracking-wider text-slate-600">Live Generated TOTP</div>
                  ...
                  <div className="text-right">
                    <div className="text-xs text-slate-700">{totpCountdown}s refresh</div>
              ...
              <div className="border border-slate-200 rounded-xl p-4 space-y-3 bg-cream/40">
                <button
                  type="button"
                ...
                {showAdvancedNetwork && (
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2 text-xs">
                    <div>
                      <label className="block text-slate-700 mb-1">Public IP (ClientPublicIP)</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="block text-slate-700 mb-1">Local IP (ClientLocalIP)</label>
                      <input
                        type="text"
                        value={creds.localIp}
                    ...
                    <div>
                      <label className="block text-slate-700 mb-1">MAC Address (MACAddress)</label>
                      <input
                        type="text"
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-3 text-xs font-mono">
                <div className="bg-white/10 p-2.5 rounded-lg flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="text-slate-200 hover:text-amber-500 p-1 rounded focus:outline-none focus:ring-2 focus:ring-amber-500/50"
            ...
            {session && (
              <Card className="space-y-4">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-amber-500/20 flex items-center justify-center text-navy font-bold">
                    <User size={20} />
                  </div>
                  <div>
                    ...
                    <div className="text-xs text-slate-700">Angel One Account Active</div>
                  </div>
                </div>
                ...
                {funds && (
                  <div className="grid grid-cols-2 gap-2 pt-2 border-t border-slate-100 text-xs">
                    <div className="p-2.5 bg-slate-50 rounded-lg">
                      <span className="text-slate-600 block text-[10px]">AVAILABLE CASH</span>
                      <span className="font-semibold text-navy">{formatCurrency(funds.availablecash)}</span>
                    </div>
                    <div className="p-2.5 bg-slate-50 rounded-lg">
                      <span className="text-slate-600 block text-[10px]">TOTAL MARGIN</span>
            ...
            <div className="space-y-3 text-xs text-slate-600">
              ...
              <div className="p-3 bg-slate-50 rounded-xl border border-slate-200">
                ...
                <p>
                  ...
                  <code className="bg-slate-200 px-1 py-0.5 rounded">JBSWY3DPEHPK3PXP...</code>). Copy this Secret string!
                </p>
              </div>
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <Card className="bg-white">
              <div className="text-xs text-slate-700 font-medium">Total Live Portfolio Value</div>
              <div className="text-2xl font-serif font-bold text-navy mt-1">{formatCurrency(totalHoldingsValue)}</div>
              <div className="text-xs text-slate-600 mt-1">{holdings.length} Positions</div>
            </Card>

            <Card className="bg-white">
              <div className="text-xs text-slate-700 font-medium">Total Unrealized P&L</div>
            ...
            <Card className="bg-amber-500/10 border-amber-500/30 flex flex-col justify-between">
              <div>
          ...
          <Card className="overflow-x-auto">
            ...
            {holdings.length === 0 ? (
              ...
              <table className="w-full min-w-[540px] text-left text-xs">
                <thead>
                  <tr className="border-b border-slate-200 text-slate-600 uppercase tracking-wider text-[10px]">

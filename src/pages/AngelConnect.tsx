        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card className="lg:col-span-2 space-y-6">
            ...
            <form onSubmit={handleConnect} className="space-y-4">
              ...
              <div className="border border-stone-200 rounded-xl p-4 space-y-3 bg-cream/40">
                <button
                  type="button"
          ...
          <div className="space-y-6">
            <Card className="bg-navy text-white relative overflow-hidden">
              ...
              <h3 className="text-lg font-serif text-gold mb-2">Network & Identity</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card className="space-y-5">
            <h3 className="text-lg font-serif text-navy flex items-center gap-2">
              <Key size={20} className="text-gold" /> Step 1: Create App on Angel One Portal
            </h3>
            ...
            <div className="space-y-3 text-xs text-stone-600">
              ...
              <div className="p-3 bg-stone-50 rounded-xl border border-stone-200">
                ...
                <ul className="space-y-1.5 font-mono">
                  <li className="flex justify-between items-center bg-white p-2 rounded border border-stone-200">
                    <span>App Name:</span>
          ...
          <Card className="space-y-5">
            <h3 className="text-lg font-serif text-navy flex items-center gap-2">
              <ShieldCheck size={20} className="text-gold" /> Step 2: Enable Automated TOTP
            </h3>
            ...
            <div className="space-y-3 text-xs text-stone-600">
              ...
              <div className="p-3 bg-stone-50 rounded-xl border border-stone-200">
                ...
                <p>
                  ...
                  <code className="bg-stone-200 px-1 py-0.5 rounded">JBSWY3DPEHPK3PXP...</code>). Copy this Secret string!
                </p>
              </div>
      ...
      {activeTab === 'holdings' && (
        <div className="space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <Card className="bg-gold/10 border-gold/30 flex flex-col justify-between">
              <div>
      ...
      {activeTab === 'scripts' && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card className="space-y-4">
            <div className="flex items-center justify-between">
              <h3 className="text-base font-serif text-navy flex items-center gap-2">
                <Terminal size={18} className="text-gold" /> Node.js Standalone Script
              </h3>
          ...
          <Card className="space-y-4">
            <div className="flex items-center justify-between">
              <h3 className="text-base font-serif text-navy flex items-center gap-2">
                <Terminal size={18} className="text-gold" /> Python Connector Script
              </h3>

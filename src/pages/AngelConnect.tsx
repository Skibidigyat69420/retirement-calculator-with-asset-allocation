      ...
      <div className="flex border-b border-border gap-6 overflow-x-auto whitespace-nowrap">
        <button
          ...
          className={`pb-3 text-sm font-semibold transition-all relative ${
            activeTab === 'connect' ? 'text-navy border-b-2 border-amber-500' : 'text-muted hover:text-navy'
          }`}
        >
        ...
        <button
          ...
          className={`pb-3 text-sm font-semibold transition-all relative ${
            activeTab === 'guide' ? 'text-navy border-b-2 border-amber-500' : 'text-muted hover:text-navy'
          }`}
        >
        ...
        <button
          ...
          className={`pb-3 text-sm font-semibold transition-all relative ${
            activeTab === 'holdings' ? 'text-navy border-b-2 border-amber-500' : 'text-muted hover:text-navy'
          }`}
        >
        ...
        <button
          ...
          className={`pb-3 text-sm font-semibold transition-all relative ${
            activeTab === 'scripts' ? 'text-navy border-b-2 border-amber-500' : 'text-muted hover:text-navy'
          }`}
        >
      ...
      {activeTab === 'connect' && (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card className="lg:col-span-2 space-y-6">
            <div className="flex items-center justify-between">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="text-xs text-navy flex items-center gap-1 hover:text-ink underline"
              >
              ...
              <div
                className={`p-3.5 rounded-xl text-sm flex items-start gap-2.5 ${
                  statusMessage.type === 'success'
                    ...
                    ? 'bg-rose-50 text-negative border border-negative/40'
                    : 'bg-sunken text-ink-soft border border-border'
                }`}
              >
                {statusMessage.type === 'success' ? (
            ...
            <form onSubmit={handleConnect} className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    aria-label="API Key"
                    className="w-full px-3.5 py-2.5 bg-surface border border-border rounded-xl text-sm font-mono focus:outline-none focus:border-navy"
                    required
                  />
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 bg-surface border border-border rounded-xl text-sm focus:outline-none focus:border-navy"
                    required
                  />
                </div>
                ...
                <div>
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="text-[11px] text-navy hover:text-ink underline flex items-center gap-1"
                    >
              ...
              {/* TOTP Live Preview */}
              {creds.totpSecret && (
                <div className="p-3 bg-sunken rounded-xl border border-border flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-lg bg-sunken/10 flex items-center justify-center text-navy font-bold">
                      <Clock size={16} />
                    </div>
                    <div>
                      <div className="text-[11px] uppercase tracking-wider text-muted">Live Generated TOTP</div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2 text-xs">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-2.5 py-1.5 bg-surface border border-border rounded-lg font-mono text-xs"
                      />
                    </div>
                    <div>
              ...
              {session && (
                <div className="pt-4 border-t border-border">
                  ...
                  {historicalTest.count > 0 && (
                    <p className="text-xs text-positive mt-2 text-center">
          ...
          <div className="space-y-6">
            <Card className="bg-sunken text-ink relative overflow-hidden">
              ...
              <div className="space-y-3 text-xs font-mono">
                <div className="bg-ink/10 p-2.5 rounded-lg flex items-center justify-between">
                  <div>
                    <span className="text-ink block text-[10px]">PUBLIC IP</span>
                    <span className="text-ink font-semibold">{creds.publicIp}</span>
                  </div>
                  <button
                    onClick={() => handleCopy(creds.publicIp, 'pubIp')}
                    className="text-ink hover:text-ink p-1 rounded focus:outline-none focus:ring-2 focus:ring-focus-ring/50"
                ...
                <div className="bg-ink/10 p-2.5 rounded-lg flex items-center justify-between">
                  <div>
                    <span className="text-ink block text-[10px]">LOCAL IP</span>
                ...
                <div className="bg-ink/10 p-2.5 rounded-lg flex items-center justify-between">
                  <div>
                    <span className="text-ink block text-[10px]">MAC ADDRESS</span>
            ...
            {session && (
              <Card className="space-y-4">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-ink/20 flex items-center justify-center text-navy font-bold">
                    <User size={20} />
                  </div>
                  <div>
                ...
                {funds && (
                  <div className="grid grid-cols-2 gap-2 pt-2 border-t border-border text-xs">
                    <div className="p-2.5 bg-sunken rounded-lg">
                      <span className="text-muted block text-[10px]">AVAILABLE CASH</span>
                      <span className="font-semibold text-navy">{formatCurrency(funds.availablecash)}</span>
                    </div>
                    <div className="p-2.5 bg-sunken rounded-lg">
                      <span className="text-muted block text-[10px]">TOTAL MARGIN</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card className="space-y-5">
            ...
            <div className="space-y-3 text-xs text-muted">
              <div className="p-3 bg-sunken rounded-xl border border-border">
              ...
              <div className="p-3 bg-sunken rounded-xl border border-border">
                ...
                <ul className="space-y-1.5 font-mono">
                  <li className="flex justify-between items-center bg-surface p-2 rounded border border-border">
                    <span>App Name:</span>
          ...
          <Card className="space-y-5">
            ...
            <div className="space-y-3 text-xs text-muted">
              ...
              <div className="p-3 bg-emerald-50 rounded-xl border border-positive/40 text-emerald-900">
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <Card className="bg-surface">
              ...
              <div className="text-xs text-muted mt-1">{holdings.length} Positions</div>
            </Card>

            <Card className="bg-surface">
              <div className="text-xs text-ink-soft font-medium">Total Unrealized P&L</div>
              <div className={`text-2xl font-serif font-bold mt-1 ${totalPnL >= 0 ? 'text-positive' : 'text-negative'}`}>
            ...
            <Card className="bg-emerald-50/10 border-positive/40/30 flex flex-col justify-between">
              <div>
            ...
            {holdings.length === 0 ? (
              ...
              <table className="w-full min-w-[540px] text-left text-xs">
                ...
                <tbody className="divide-y divide-border">
                  {holdings.map((h, idx) => (
                    <tr key={idx} className="hover:bg-sunken/80 transition-colors">
                      <td className="py-3 font-semibold text-navy flex items-center gap-2">
                        <TrendingUp size={14} className="text-muted" />
                        <div>
                          <div>{h.tradingsymbol}</div>
                          <span className="text-[10px] text-muted font-normal">{h.exchange}</span>
                        </div>
                      </td>
                      ...
                      <td className={`py-3 text-right font-mono font-semibold ${h.pnl >= 0 ? 'text-positive' : 'text-negative'}`}>
      ...
      {activeTab === 'scripts' && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card className="space-y-4">
            ...
            <div className="bg-sunken text-ink p-4 rounded-xl font-mono text-xs overflow-x-auto">
              <code>
